...
public class CalendarUtils {
    ...
    public static String getValueAsString(FacesContext context, Calendar calendar, Object value) {
        ...
        if (calendar.getConverter() != null) {
            return calendar.getValueExpression("value").getType(context.getELContext()).isAssignableFrom(value.getClass()) ?
                   calendar.getConverter().getAsString(context, calendar, value) : null;
