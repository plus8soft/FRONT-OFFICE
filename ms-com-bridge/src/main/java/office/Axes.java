...
public interface Axes extends Com4jObject,Iterable<Com4jObject> {
  ...
  @VTID(8)
  office.IMsoAxis item(office.XlAxisType type, @Optional @DefaultValue("1") office.XlAxisGroup axisGroup);
  ...
  @VTID(12)
  @DefaultMethod
  office.IMsoAxis _Default(office.XlAxisType type, @Optional @DefaultValue("1") office.XlAxisGroup axisGroup);
